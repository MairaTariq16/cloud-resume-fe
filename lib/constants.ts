  ...
  items: [
    {
      ...
      description: [
        "Orchestrated application deployments on Azure to support AI-driven web applications, leveraging Azure Kubernetes Service, App Services, PostgreSQL servers, and OpenAI Service, among other technologies",
        "Setup and maintained Docker containers and Kubernetes clusters, ensuring smooth operations in challenging air-gapped environments",
        "Automated DNS management, SSL/TLS certificate issuance, and ingress controller setup with externalDNS, cert-manager, and ingress-nginx in Kubernetes clusters",
        "Streamlined infrastructure management with Pulumi for IaC, ensuring consistent deployments, reducing provisioning time by over 70% while minimizing manual errors",
        "Designed and implemented automated CI/CD processes with BitBucket Pipelines, Github Actions and ArgoCD",
        "Implemented GitOps practices using ArgoCD for automated deployments to Kubernetes clusters",
        "Developed a Python utility for backup and restore of PostgreSQL databases in air-gapped Kubernetes clusters",
        "Demonstrated a commitment to operational excellence by providing production support, including triaging critical bugs and resolving issues promptly, and being available for on-call support",
      ],
...
export const PROJECTS: Content = {
  ...
  items: [
    ...
    },
    {
      ...
      description: [
        "Developed a prototype for mobile application converting Urdu audio to PSL signs using Flutter, Flask and OpenPose",
